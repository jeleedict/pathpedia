...
/**
 * Class for child SP reports <br/>
 * 
 * @author hjsong
 */
public class ChildSurgeonDocument extends BioMedicalDocument implements Cloneable{
	...
	public ChildSurgeonDocument(String pathologyID, String abbrPathologyID ){
		super( pathologyID );
	...
	public Object clone() throws CloneNotSupportedException {
		ChildSurgeonDocument csd = (ChildSurgeonDocument)super.clone();
		return csd;
	}	
}
